		...
		<main class="">
			<header class="mb-8">
				<div class="flex items-center gap-3 mb-1">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4 text-white shrink-0">
					...
					<span class="text-xl">Private Connect</span>
				</div>
				<p class="mb-3 text-gray-400">Access private services without VPN or firewall rules.</p>
			</header>
			<ol class="list-inside text-sm text-left text-white space-y-4">
				<li class="flex items-start">
					<div class="w-5 h-5 mr-2 flex text-xs flex-none items-center justify-center bg-gray-500/10 rounded-md text-gray-400">
						1
					</div>
				...
				<li class="flex items-start">
					...
					<span class="text-white flex gap-1">
						<span class="font-semibold">If you continue to see this error, contact us</span>
						<div class="inline-flex items-center gap-3 ml-1">
							...
							<a href="https://x.com/treadieinc" class="text-gray-400 hover:text-white flex items-center">
			...
			<div class="text-gray-400 mt-10">
				<a class="flex items-center gap-2 hover:text-white text-sm" href="/" rel="noopener noreferrer">
...
useHead({ title: '404 - Private Connect' })
</script>

    ...
    <section class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-10 relative z-10">
      <div class="text-center">
        ...
        <div class="mt-10 mb-4">
          <div 
            @click="copyInstall"
            class="inline-flex items-center cursor-pointer bg-black/60 border border-gray-500/15 rounded-lg px-4 py-2 font-mono text-xs group hover:bg-gray-500/15 transition-colors"
            :title="copied ? 'Copied!' : 'Click to copy'"
          >
            <span class="text-gray-500 mr-2">$</span>
            <span class="text-gray-400">curl -fsSL https://privateconnect.co/install.sh | bash</span>
            <span class="ml-4 text-gray-500 group-hover:text-white transition-colors">

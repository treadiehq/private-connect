<template>
  <div class="min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
      ...
      <!-- Not Authenticated -->
      <div v-if="!user" class="bg-gray-900 border border-gray-700 rounded-xl p-8 text-center">
        <div class="w-16 h-16 mx-auto mb-6 rounded-full bg-blue-300/20 flex items-center justify-center">
      ...
      <div v-else-if="!verified" class="bg-gray-900 border border-gray-700 rounded-xl p-8">
        ...
        <form @submit.prevent="verifyCode">
          <div class="mb-6">
            <input
              ...
              maxlength="9"
              class="w-full px-4 py-4 text-center text-2xl font-mono tracking-widest bg-black border border-gray-700 rounded-lg focus:border-blue-300 focus:ring-1 focus:ring-blue-300 focus:outline-none transition-colors uppercase"
          ...
          <button
            ...
            class="w-full py-3 bg-blue-300 hover:bg-blue-400 disabled:opacity-50 disabled:cursor-not-allowed text-black font-medium rounded-lg transition-colors"
          >
      ...
      <!-- Success -->
      <div v-else class="bg-gray-900 border border-gray-700 rounded-xl p-8 text-center">
        <div class="w-16 h-16 mx-auto mb-6 rounded-full bg-green-400/20 flex items-center justify-center">
